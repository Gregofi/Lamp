...
TEST(LexerTest, NumberParsingSimple)
{
    ...
    Lexer lexer(iss);
    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::INT_LITERAL);
    ...
    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::FLOAT_LITERAL);
...
TEST(LexerTest, IdentifiersAndKeywordsTest)
{
    ...
    Lexer lexer(iss);
    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::IDENTIFIER);
    ...
    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::RETURN);
    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::DEF);
    ...
    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::IF);
...
TEST(LexerTest, AE)
{
    ...
    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::OP_PLUS);

    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::FLOAT_LITERAL);
    EXPECT_EQ(lexer.GetDoubleVal(), 2.3);

    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::OP_ASTERISK);

    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::INT_LITERAL);
    EXPECT_EQ(lexer.GetIntVal(), 32);

    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::OP_DIVIDE);
    ...
    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::OP_MINUS);
...
TEST(LexerTest, Brackets)
{
    ...
    Lexer lexer(iss);
    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::INT_LITERAL);
    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::LBRACKET); 
    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::INT_LITERAL);
    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::RBRACKET);
    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::LBRACKET);
    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::INT_LITERAL);
    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::RBRACKET);
    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::INT_LITERAL);
...
TEST(LexerTest, If)
{
    ...
    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::OP_PLUS);
    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::INT_LITERAL);
    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::ELSE);
    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::INT_LITERAL);
    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::OP_PLUS);
    EXPECT_EQ(lexer.GetNextToken(), Token::Kind::INT_LITERAL);
}
